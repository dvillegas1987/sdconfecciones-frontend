...
function MatTabGroup_div_2_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const tab_r1904 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("cdkPortalOutlet", tab_r1904.templateLabel);
} }
function MatTabGroup_div_2_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const tab_r1904 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵtextInterpolate(tab_r1904.textLabel);
} }
function MatTabGroup_div_2_Template(rf, ctx) { if (rf & 1) {
    const _r1912 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 6);
    ɵngcc0.ɵɵlistener("click", function MatTabGroup_div_2_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r1912); const tab_r1904 = ctx.$implicit; const i_r1905 = ctx.index; const ctx_r1911 = ɵngcc0.ɵɵnextContext(); const _r1900 = ɵngcc0.ɵɵreference(1); return ctx_r1911._handleClick(tab_r1904, _r1900, i_r1905); });
    ...
    const tab_r1904 = ctx.$implicit;
    const i_r1905 = ctx.index;
    const ctx_r1901 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassProp("mat-tab-label-active", ctx_r1901.selectedIndex == i_r1905);
    ɵngcc0.ɵɵproperty("id", ctx_r1901._getTabLabelId(i_r1905))("disabled", tab_r1904.disabled)("matRippleDisabled", tab_r1904.disabled || ctx_r1901.disableRipple);
    ɵngcc0.ɵɵattribute("tabIndex", ctx_r1901._getTabIndex(tab_r1904, i_r1905))("aria-posinset", i_r1905 + 1)("aria-setsize", ctx_r1901._tabs.length)("aria-controls", ctx_r1901._getTabContentId(i_r1905))("aria-selected", ctx_r1901.selectedIndex == i_r1905)("aria-label", tab_r1904.ariaLabel || null)("aria-labelledby", !tab_r1904.ariaLabel && tab_r1904.ariaLabelledby ? tab_r1904.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", tab_r1904.templateLabel);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !tab_r1904.templateLabel);
} }
function MatTabGroup_mat_tab_body_5_Template(rf, ctx) { if (rf & 1) {
    const _r1916 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "mat-tab-body", 10);
    ɵngcc0.ɵɵlistener("_onCentered", function MatTabGroup_mat_tab_body_5_Template_mat_tab_body__onCentered_0_listener() { ɵngcc0.ɵɵrestoreView(_r1916); const ctx_r1915 = ɵngcc0.ɵɵnextContext(); return ctx_r1915._removeTabBodyWrapperHeight(); })("_onCentering", function MatTabGroup_mat_tab_body_5_Template_mat_tab_body__onCentering_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1916); const ctx_r1917 = ɵngcc0.ɵɵnextContext(); return ctx_r1917._setTabBodyWrapperHeight($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const tab_r1913 = ctx.$implicit;
    const i_r1914 = ctx.index;
    const ctx_r1903 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassProp("mat-tab-body-active", ctx_r1903.selectedIndex == i_r1914);
    ɵngcc0.ɵɵproperty("id", ctx_r1903._getTabContentId(i_r1914))("content", tab_r1913.content)("position", tab_r1913.position)("origin", tab_r1913.origin)("animationDuration", ctx_r1903.animationDuration);
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r1903._getTabLabelId(i_r1914));
} }
